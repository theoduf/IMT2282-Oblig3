...
foreach($i in $args){
  ...
  New-Item ".\$i--$now.meminfo" -ItemType file -Force -Value "******** Minne info om prosess med PID $i ******** `r`n Total bruk av virtuelt minne: $vm `r`n St`ørrelse p`å Working Set: $ws"
